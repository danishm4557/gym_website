  ...
  return <section id="contactus" className="mx-auto w-5/6 pt-24 pb-32">
	<motion.div onViewportEnter={() => setSelectedPage(SelectedPage.ContactUs)}>
		...
		>
			...
			<p className="my-5">
				Join EvoGym now and take your fitness to the next level! With state-of-the-art equipment, expert trainers, and a supportive community, EvoGym is your ultimate destination for achieving your health goals. Don't wait—start your transformation today!
			</p>
		</motion.div>
